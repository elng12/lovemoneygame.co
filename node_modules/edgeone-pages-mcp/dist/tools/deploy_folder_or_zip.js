 ...
 */
const getProjectConsoleUrl = (projectId) => {
...
const getDeploymentStructuredResult = async (deploymentResult, projectId, env = 'Production') => {
    ...
    if (deploymentResult.Status === 'Success') {
        ...
        console.log(`[getDeploymentStructuredResult] Deployment failed with status: ${deploymentResult.Status}`);
